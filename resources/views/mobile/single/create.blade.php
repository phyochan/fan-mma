...
@section('content')
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-mobile"></i> Mobile Api - Add New Songs</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="{{URL::to('backend/admin')}}">Home</a></li>
                        <li><i class="fa fa-mobile"></i>Mobile Api - Add New Songs</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        ...
                        <form action="{{url('/backend/admin/mobile/songs/')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="categories" t>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" required rows="8" placeholder="Enter Song Content" name="content"></textarea>
