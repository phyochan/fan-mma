            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        ...
                        <form method="POST"  action="{{url('/backend/admin/ug/email',$send -> id)}}"  accept-charset="UTF-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  required name="email" value="{{$send -> email}}">
